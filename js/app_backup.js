  ...
  .then((data) => {
    ...
    data.courses.forEach((course) => {
      ...
      div.innerHTML = `
        ...
        course.title
      }" loading="lazy" onerror="this.src='https://via.placeholder.com/300x200?text=Workshop'">
        <div class="course-card-content">
          <span class="course-tag px-3 py-1 bg-red-500 text-white text-xs font-semibold rounded-full mb-3">${
            course.tag || "LIVE"
          }</span>
  ...
  .then((data) => {
    ...
    data.courses.forEach((course) => {
      ...
      div.innerHTML = `
        <img class="course-card-image" src="${course.image}" alt="${
        course.title
      }" loading="lazy" onerror="this.src='https://via.placeholder.com/300x200?text=Live+Training'">
        <div class="course-card-content">
          <span class="course-tag px-3 py-1 bg-green-500 text-white text-xs font-semibold rounded-full mb-3">${
            course.tag || "LIVE"
          }</span>
          <div class="course-card-title">
            <a class="text-lg font-semibold hover:text-bkash-pink transition-colors" href="${
